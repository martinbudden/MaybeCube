...
function spoolHolderPosition(offsetX=0) = [eX + 2*eSize + 10 + offsetX, eY/2 + (eY==250 ? 0 : eY==300 ? 25 : eY==350 ? 45 : 40), spoolHeight() + 2*eSize];
...
function iecHousingMountSize(eX=eX) = [iecHousingSize().x + eSize + (_useElectronicsInBase ? 5 : 0), eX==250 ? spoolHeight(eX) + eSize : iecHousingSize().y + 2*eSize, 3];
