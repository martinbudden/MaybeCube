...
function extruderPosition(eX=eX) = [eX + 2*eSize, eY + 2*eSize - 45, eX < 400 ? eZ - 90 : eZ - 140];
...
function iecHousingMountSize(extended=false) = [iecHousingSize().x + eSize, iecHousingSize().y + (extended ? 2*eSize : eSize), 3];
